...
class Devis
{
     ...
     *
     * @Assert\NotBlank(message="Merci d'indiquer votre civilité.")
     */
    private $civilite;
    ...
    /**
     * @ORM\Column(type="string", length=255)
     * @Assert\NotBlank(message="Merci d'indiquer votre adresse mail.")
    ...
    /**
     * @ORM\Column(type="string", length=255)
     * @Assert\NotBlank(message="Merci d'indiquer votre adresse.")
     * @Assert\Length(
     *      min = 2,
     *      max = 100,
     ...
     *
     * @Assert\NotBlank(message="Merci de remplir la description de votre projet.")
     */
    private $description;
